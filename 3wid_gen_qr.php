...
$hash = $_GET["hash"];
$target_url="https://www.3wordid.com/index.php?hash=";

$qr_string = $target_url . $hash;
...
$qrcode->render($data, 'qr_codes/qrcode_' . $hash . '.png'); // Save to file
// Or output directly:
echo "<img src='qr_codes/qrcode_" . $hash . ".png" . "'>";
?>
