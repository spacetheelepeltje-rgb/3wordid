...
<body>
    ...
    <main>
        <div class="logo">
            ...
            <a href='3wid_signup.php'><button class="buttons">Subscribe click here so your 3WordID doesn't expire</button></a><br>
            <div id="helpertext"><strong><?php echo $message; ?></strong></div>
            </center>
        </div>
        ...
        <div class="row">
            ...
            <span class="cell actions">
                ...
                ?>
                <a class="mail-icon" href="3wid_add.php?user_token=<?php echo $_SESSION["user_token"]; ?>" title="<?php echo $title; ?>">
        ...
        ?>
            <div class="row">
                <span class="cell three-word-id">
                    <a href="3wid_forward.php?threewords=<?php echo $db_3wordid_item['threeword'] ?>" class="<?php if ($db_3wordid_item['enabled'] != 1) { 
						echo "grayed-out"; } ?>" title="id : <?php echo $db_3wordid_item['id'] ?> views : <?php echo $db_3wordid_item['views']; ?> created : <?php 
						echo $db_3wordid_item['creation_date']; ?> days to expire : <?php echo db_3wid_daysUntilNWeeksAfter($db_3wordid_item['creation_date'],4); ?>">
                        <strong><?php echo $db_3wordid_item['threeword']; ?></strong><br>
                        <?php echo $threeword_url; ?>
                    </a>
                </span>
                <span class="cell">
        ...
        <!-- Reseller Code Row -->
        <div class="row">
            <span class="cell three-word-id">Reseller code : <?php echo $data["id"] . substr(trim($data["email"]), -5); ?> (<a href="3wid_reseller.php">?</a>)</span>
            <span class="cell">
