...
function sleep(miliseconds) {
 ...
 $(document).ready(function() {
    ...
    $('#formSearch').on('submit', function(event) {
        ...
        nolinkthru = $('#noLinkThru').is(':checked');
        ...
        $.ajax({
            ...
            success: function(response) {		
				...
				if (jsonObject.status === 'ok') {
                    ...
                    window.location.href = 'known.php?nolinkthru='+ nolinkthru +'&threewords=' + threewords + '&hash=' + jsonObject.hash; // Replace with the URL of the page you want to redirect to
                    $('p#helperText').css('color', 'green');
                    
					} else {
						
					//console.log('forward to create');
                    window.location.href = 'new.php?threewords=' + threewords + '&hash=' + jsonObject.hash; // Replace with the URL of the page you want to redirect to
                    $('p#helperText').css('color', 'red');	
