<?php
  ...
  error_log(' ip ' . $client_ip . ' recent page');
...
<body>
    ...
    <main>    
        ...
        <table>
		   <div style="margin-bottom: 12px;margin-left: 20px;">If you don't want to be visible here, set your 3WordID to 'private'<br>
           <thead>
                <tr>
                    <th>Three Word ID</th>
                    <th>Link</th>
            ...
            <tbody>
				...
				?>
                <tr>
                    <td><a href="<?php echo $db_3wordid_item['threeword'] . '">' . $db_3wordid_item['threeword']; ?></a></td>
                    <td>
